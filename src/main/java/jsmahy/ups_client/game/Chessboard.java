...
public final class Chessboard {
	 ...
	 * @throws IllegalAccessError    if the client attempted to move opponents piece and the client called this method
	 *                               for some reason
	 */
	...
	public void setPiece(Square square, char piece) {
	 ...
	 *
	 * @return {@code true} if the two squares next to the king based on the castle type are not under attack of the
	 * opponent
	 */
	 ...
	 *
	 * @return {@link ChessMove#CASTLES_SHORT} or {@link ChessMove#CASTLES_LONG} or chessMove if the move was either
	 * not
	 * a castles move or the king cannot castle
	 */
	...
	// TODO return the colour as well
	/**
